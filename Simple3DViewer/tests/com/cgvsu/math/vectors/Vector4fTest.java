...
class Vector4fTest {
    ...
    void testAdd() {
        ...
        assertEquals(8.0, result.y(), 1e-7);
    ...
    void testSubtract() {
        ...
        assertEquals(3.0, result.y(), 1e-7);
    ...
    void testGetNormalized() {
        ...
        assertEquals(0.8321, result.y(), 1e-4);
    ...
    void testTruncate() {
        ...
        assertEquals(2.0, truncated.y(), 1e-7);

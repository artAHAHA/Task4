...
public class GraphicConveyor {
    ...
    public static javax.vecmath.Vector3f multiplyMatrix4ByVector3(final Matrix4f matrix, final javax.vecmath.Vector3f vertex) {
    ...
    public static Point2f vertexToPoint(final javax.vecmath.Vector3f vertex, final int width, final int height) {
